/**
 * @file ヘルパー: 支出カテゴリ CRUD フォームの共通バリデーション・fetch 補助関数
 * @module src/lib/features/expenses/categories/components/form-helpers.ts
 * @feature expenses/categories
 *
 * @description
 * ExpenseCategoriesPage の追加・編集・削除ハンドラで共通する
