/**
 * @file API: 支出確認取消
 * @module src/routes/expenses/[id]/uncheck/+server.ts
 * @feature expenses
 *
 * @description
 ...
 * @acceptance AC-005, AC-114
 *
 * @endpoints
 * - POST /expenses/[id]/uncheck → 200 ExpenseWithRelations - 支出確認取消
...
import { uncheckExpense } from '../../service';

/**
 * checked の支出を unapproved に戻す。
 * @ac AC-005, AC-114
