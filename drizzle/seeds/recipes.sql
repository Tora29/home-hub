...
(
  ...
  4, 30,
  5, strftime('%s', '2026-03-20'),
  'excellent', 'easy', '甘さ控えめが好み。砂糖を少し減らすとちょうどいい。',
  strftime('%s', '2026-01-10'), strftime('%s', '2026-03-20')
),
(
  'seed-recipe-002',
  (SELECT id FROM "User" LIMIT 1),
  ...
  2, 20,
  8, strftime('%s', '2026-03-22'),
  'excellent', 'easy', 'キャベツの千切りと一緒に盛り付けると見栄えがいい。',
  strftime('%s', '2026-01-15'), strftime('%s', '2026-03-22')
),
(
  'seed-recipe-003',
  (SELECT id FROM "User" LIMIT 1),
  ...
  2, 40,
  3, strftime('%s', '2026-03-01'),
  'good', 'medium', 'むね肉を使うとヘルシー。揚げたてが一番おいしい。',
  strftime('%s', '2026-02-01'), strftime('%s', '2026-03-01')
),
(
  'seed-recipe-004',
  (SELECT id FROM "User" LIMIT 1),
  ...
  2, 25,
  4, strftime('%s', '2026-03-15'),
  'excellent', 'medium', '辛さは豆板醤の量で調整。花椒を多めに入れると本格的な痺れになる。',
  strftime('%s', '2026-01-20'), strftime('%s', '2026-03-15')
),
(
  'seed-recipe-005',
  (SELECT id FROM "User" LIMIT 1),
  ...
  2, 20,
  6, strftime('%s', '2026-03-18'),
  'good', 'easy', 'トースターが便利。バターをポン酢に変えてもさっぱりしておいしい。',
  strftime('%s', '2026-02-10'), strftime('%s', '2026-03-18')
),
(
  'seed-recipe-006',
  (SELECT id FROM "User" LIMIT 1),
  ...
  4, 50,
  10, strftime('%s', '2026-03-23'),
  'excellent', 'easy', '隠し味にチョコレートとコーヒーを少し入れるとコクが出る。',
  strftime('%s', '2026-01-05'), strftime('%s', '2026-03-23')
),
(
  'seed-recipe-007',
  (SELECT id FROM "User" LIMIT 1),
  ...
  2, NULL,
  'good', 'easy', NULL,
  strftime('%s', '2026-03-01'), strftime('%s', '2026-03-01')
),
(
  'seed-recipe-008',
  (SELECT id FROM "User" LIMIT 1),
  ...
  2, 20,
  1, NULL,
  'average', 'hard', '卵が固まらないよう火加減が難しい。茹で汁で調整しながら素早く混ぜるのがコツ。',
  strftime('%s', '2026-03-10'), strftime('%s', '2026-03-10')
);
